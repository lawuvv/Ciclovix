...
class PontosControllerTest < ActionController::TestCase
  ...
  test "should create ponto" do
    assert_difference('Ponto.count') do
      post :create, ponto: { altitude: @ponto.altitude, latitude: @ponto.latitude, longitude: @ponto.longitude }
    end
  ...
  test "should update ponto" do
    patch :update, id: @ponto, ponto: { altitude: @ponto.altitude, latitude: @ponto.latitude, longitude: @ponto.longitude }
    assert_redirected_to ponto_path(assigns(:ponto))
  end
