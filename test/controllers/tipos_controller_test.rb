...
class TiposControllerTest < ActionController::TestCase
  ...
  test "should create tipo" do
    assert_difference('Tipo.count') do
      post :create, tipo: { descricao: @tipo.descricao, enable: @tipo.enable, marcador: @tipo.marcador, type: @tipo.type }
    end
  ...
  test "should update tipo" do
    patch :update, id: @tipo, tipo: { descricao: @tipo.descricao, enable: @tipo.enable, marcador: @tipo.marcador, type: @tipo.type }
    assert_redirected_to tipo_path(assigns(:tipo))
  end
